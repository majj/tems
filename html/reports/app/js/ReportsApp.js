...
angular.module("ReportsApp", [ "ui.bootstrap", "angular-flot", "ngHandsontable" ]).controller("ReportsCtrl", [ "$scope", "$http", function($scope, $http) {
    // sheet 1
    var room = [ "重鼓试验室", "重鼓试验室", "重鼓试验室", "环境试验室", "环境试验室", "环境试验室", "耐久试验室" ];
    var equipments = [ "耐久转鼓#1", "耐久转鼓#2", "耐久转鼓#3", "环境高低温舱 \n环境高低温转鼓 \n环境排放分析仪 ", "环境常温转鼓\n环境排放分析仪 ", "四驱高温舱\n四驱高温转鼓", "重型转鼓" ];
    ...
    */
    ...
    // flot  dataset
    $scope.dataset = [ 
    {data: [],yaxis: 1,label: "计划"}, 
    {data: [],yaxis: 1,label: "实报"} ];
    $scope.dataset2 = [ 
    {data: [],yaxis: 1,label: "计划"}, 
    {data: [],yaxis: 1,label: "实报"}, 
    {data: [],yaxis: 2,label: "利用率"} ];
    // dataset 3
    $scope.dataset3 = [ 
    {data: [],yaxis: 1,label: "耐久1#"}, 
    {data: [],yaxis: 1,label: "耐久2#"}, 
    {data: [],yaxis: 1,label: "耐久3#"} ];
    // flot options
    $scope.options = {
        hoverable: true,
        shadowSize: 2,
    ...
    */
    ...
    {data: "id",title: "ID",width: 30,readOnly: true}, 
    {data: "room",title: "试验室",width: 130,readOnly: true}, 
    {data: "equipments",title: "设备名称",width: 180,readOnly: true}, 
    {data: "equipmentNos",title: "资源编号",width: 150,readOnly: true}, 
    {data: "planWorkTime",title: "计划工时(H)",width: 150,readOnly: true}, 
    {data: "realWorkTime",title: "实报工时(H)",type: "numeric",width: 150,readOnly: true} 
    ];
    // End of grid defination
    // grid
    $scope.db.dynamicColumns2 = [ 
    {data: "id",title: "ID",width: 30,readOnly: true}, 
    {data: "room",title: "试验室",width: 120,readOnly: true}, 
    {data: "equipments",title: "设备名称",width: 150,readOnly: true}, 
    {data: "equipmentNos",title: "资产编号",width: 150,readOnly: true}, 
    {data: "equipmentType",title: "类别",width: 100,readOnly: true}, 
    {data: "planWorkTime",title: "计划工时(H)",width: 120,readOnly: true}, 
    {data: "realWorkTime",title: "实报工时(H)",type: "numeric",width: 120,readOnly: true}, 
    {data: "utilRate",title: "设备利用率(%)",type: "numeric",format: "0.00%",width: 120,readOnly: true}, 
    {data: "downtime",title: "停工时间(H)",type: "numeric",width: 100,readOnly: true}, 
    {data: "note",title: "备注",width: 100,readOnly: false} 
    ];
    // End of grid defination                    
    // grid
    ...
    {data: "id",title: "ID",width: 30,readOnly: true}, 
    {data: "room",title: "试验室",width: 120,readOnly: true}, 
    {data: "equipments",title: "主要设备名称",width: 150,readOnly: true}, 
    {data: "equipmentNos",title: "资产编号",width: 150,readOnly: true}, 
    {data: "equipmentType",title: "类别",width: 100,readOnly: true}, 
    {data: "planWorkTime",title: "计划工时(H)",width: 120,readOnly: true}, 
    {data: "realWorkTime",title: "实报工时(H)",type: "numeric",width: 120,readOnly: true}, 
    {data: "utilRate",title: "设备利用率(%)",type: "numeric",format: "0.00%",width: 120,readOnly: true}, 
    {data: "downtime",title: "停工时间(H)",type: "numeric",width: 100,readOnly: true}, 
    {data: "operation1",title: "1月<br/>运转率",type: "numeric",format: "0.00%",width: 100,readOnly: true}, 
    {data: "perfectness1",title: "1月<br/>完好率",type: "numeric",format: "0.00%",width: 100,readOnly: true}, 
    {data: "operation2",title: "2月<br/>运转率",type: "numeric",format: "0.00%",width: 100,readOnly: true}, 
    {data: "perfectness2",title: "2月<br/>完好率",type: "numeric",format: "0.00%",width: 100,readOnly: true}, 
    {data: "operation3",title: "3月<br/>运转率",type: "numeric",format: "0.00%",width: 100,readOnly: true}, 
    {data: "perfectness3",title: "3月<br/>完好率",type: "numeric",format: "0.00%",width: 100,readOnly: true}, 
    {data: "operation4",title: "4月<br/>运转率",type: "numeric",format: "0.00%",width: 100,readOnly: true}, 
    {data: "perfectness4",title: "4月<br/>完好率",type: "numeric",format: "0.00%",width: 100,readOnly: true}, 
    {data: "operation5",title: "5月<br/>运转率",type: "numeric",format: "0.00%",width: 100,readOnly: true}, 
    {data: "perfectness5",title: "5月<br/>完好率",type: "numeric",format: "0.00%",width: 100,readOnly: true}, 
    {data: "operation6",title: "6月<br/>运转率",type: "numeric",format: "0.00%",width: 100,readOnly: true}, 
    {data: "perfectness6",title: "6月<br/>完好率",type: "numeric",format: "0.00%",width: 100,readOnly: true}, 
    {data: "operation7",title: "7月<br/>运转率",type: "numeric",format: "0.00%",width: 100,readOnly: true}, 
    {data: "perfectness7",title: "7月<br/>完好率",type: "numeric",format: "0.00%",width: 100,readOnly: true}, 
    {data: "operation8",title: "8月<br/>运转率",type: "numeric",format: "0.00%",width: 100,readOnly: true}, 
    {data: "perfectness8",title: "8月<br/>完好率",type: "numeric",format: "0.00%",width: 100,readOnly: true}, 
    {data: "operation9",title: "9月<br/>运转率",type: "numeric",format: "0.00%",width: 100,readOnly: true}, 
    {data: "perfectness9",title: "9月<br/>完好率",type: "numeric",format: "0.00%",width: 100,readOnly: true}, 
    {data: "operation10",title: "10月<br/>运转率",type: "numeric",format: "0.00%",width: 100,readOnly: true}, 
    {data: "perfectness10",title: "10月<br/>完好率",type: "numeric",format: "0.00%",width: 100,readOnly: true}, 
    {data: "operation11",title: "11月<br/>运转率",type: "numeric",format: "0.00%",width: 100,readOnly: true}, 
    {data: "perfectness11",title: "11月<br/>完好率",type: "numeric",format: "0.00%",width: 100,readOnly: true}, 
    {data: "operation12",title: "12月<br/>运转率",type: "numeric",format: "0.00%",width: 100,readOnly: true}, 
    {data: "perfectness12",title: "12月<br/>完好率",type: "numeric",format: "0.00%",width: 100,readOnly: true}, 
    {data: "note",title: "备注",
        //format: '0.00%',
